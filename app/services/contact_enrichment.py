...
def _extract_decision_makers(url: str, html: str) -> tuple[list[dict], list[str]]:
    ...
    # Only accept a named senior person when their professional email is visibly
    # published in the same reasonably small content block. Never derive an email
    # from a name or domain pattern.
